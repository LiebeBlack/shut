...
STRINGS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "preset_applied": "⚡ Preset aplicado: {v}",
        "armed_toast": "▶ Monitoreo armado",
        "disarmed_toast": "■ Monitoreo desarmado",
        "live_armed": "▶ {name} — monitoreo activo",
        "live_countdown": "⏱ {mm}:{ss} restantes",
        "live_risk": "🧠 Riesgo {v}%",
        ...
        "sec_activity": "Actividad reciente",
        "activity_empty": "Sin actividad registrada todavía.",
        "activity_stats": ("Armados: {armed} · Ejecutados: {fired} · "
                           "Cancelados: {cancelled} · Errores: {errors} · "
                           "Total: {total}"),
        "activity_cleared": "🧾 Actividad borrada",
        "refresh": "Refrescar",
        "warn_soon": "⚠ Quedan {s}s para la acción",
        "warn_soon_log": "⚠ Cuenta regresiva: {s}s restantes",
        "session_end": "■ Sesión: {mins} min · {n} disparos",
        "clone": "Copiar",
        "clone_name": "{name} (copia)",
        "cloned": "⧉ Perfil copiado: {name}",
        "autostart": "Iniciar con Windows",
        "autostart_on": "↻ Inicio automático activado",
        "autostart_off": "↻ Inicio automático desactivado",
        "autostart_err": "⚠ No se pudo cambiar el inicio automático",
        "next_fire": "⏰ Disparo: en {v}",
        "next_none": "⏰ Sin disparo programado",
        "next_other": "⏰ Modo sin temporizador",
        "abort_os": "Abortar apagado del sistema",
        "abort_os_ok": "⛔ Apagado del sistema abortado",
        "tray_arm": "Armar monitoreo",
        "tray_disarm": "Desarmar",
        "tray_armed": "Monitoreo armado",
        "tray_disarmed": "Monitoreo desarmado",
    },
    "en": {
        ...
        "clear": "Clear",
        "accent": "Accent color",
        "preset_applied": "⚡ Preset applied: {v}",
        "armed_toast": "▶ Monitoring armed",
        "disarmed_toast": "■ Monitoring disarmed",
        "live_armed": "▶ {name} — monitoring active",
        "live_countdown": "⏱ {mm}:{ss} remaining",
        "live_risk": "🧠 Risk {v}%",
        ...
        "activity_stats": ("Armed: {armed} · Executed: {fired} · "
                           "Cancelled: {cancelled} · Errors: {errors} · "
                           "Total: {total}"),
        "activity_cleared": "🧾 Activity cleared",
        "refresh": "Refresh",
        "warn_soon": "⚠ {s}s until the action",
        "warn_soon_log": "⚠ Countdown: {s}s remaining",
        "session_end": "■ Session: {mins} min · {n} triggers",
        "clone": "Clone",
        "clone_name": "{name} (copy)",
        "cloned": "⧉ Profile cloned: {name}",
        "autostart": "Start with Windows",
        "autostart_on": "↻ Autostart enabled",
        "autostart_off": "↻ Autostart disabled",
        "autostart_err": "⚠ Could not change autostart",
        "next_fire": "⏰ Fires in {v}",
        "next_none": "⏰ No scheduled trigger",
        "next_other": "⏰ Mode has no timer",
        "abort_os": "Abort system shutdown",
        "abort_os_ok": "⛔ System shutdown aborted",
        "tray_arm": "Arm monitoring",
        "tray_disarm": "Disarm",
        "tray_armed": "Monitoring armed",
        "tray_disarmed": "Monitoring disarmed",
    },
}
